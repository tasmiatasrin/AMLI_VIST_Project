...
def get_sentences(word_ids,vocab):
    ...
    for col in range(batch):
        ...
        for row in range(sent_len):
            word = vocab[str(int(word_ids[row][col]))]
...
def weight_gloVe(target_vocab):
    ...
    home_dir = '/Users/jcollins/Desktop/AMLI/Capstone/'

    os.chdir(home_dir)
    
    return weights_matrix,len(target_vocab)
...
def main(args):
    ...
    # directories
    home_dir = '/Users/jcollins/Desktop/AMLI/Capstone/'
    train_pickle_dir = '/Users/jcollins/Desktop/AMLI/Capstone/Train Data/pickles/'
    val_pickle_dir = '/Users/jcollins/Desktop/AMLI/Capstone/val_pickles/'
    dict_dir = '/Users/jcollins/Desktop/AMLI/Capstone/Dictionaries/'
    ...
    pretrained_word_weight, vocab_size = weight_gloVe(in_vocab)
    print(vocab_size)
    ...
    for epoch in range(0, args.num_epochs):  
        ...
        with torch.no_grad():
            ...
            for val_step in range(0, total_val_step):
                ...
                predicted_sentences = get_sentences(output_ids,out_vocab)
        ...
        print('\r' + stats)
        #sys.stdout.flush()
        os.chdir('/Users/jcollins/Desktop/AMLI/Capstone/vist_code/')
        # Save the weights.
        if epoch % 10 == 0:
            print("\nSaving the model")
            ...
            json.dump(inference_advice,open('predicted-v1-epoch-%d.json' % epoch,'w'))  
            #train_data_loader, val_data_loader = update_data_loader(vist_dataset, data_indices)
